...
export default function Index() {
  ...
  return (
    <div className="flex flex-1">
          ...
          <div className="w-full max-w-xs space-y-8 text-center">
            <div>
              <Link className="mx-auto flex justify-center" to="/">
                <svg
                  className="block h-9 text-black dark:text-white"
                  viewBox="0 0 366 71"
                  fill="currentColor"
            ...
            <div className="flex flex-col items-center justify-center space-y-5">
              <button className="bg-pink-400 hover:bg-pink-500 transition-all active:shadow-flat-sm w-full border text-black font-medium border-black shadow-flat py-3 px-4">
                <span>Signup to get started</span>
              </button>
              <Link
                to="/login"
                className="bg-yellow-300 hover:bg-yellow-400 transition-all active:shadow-flat-sm w-full border text-black font-medium border-black shadow-flat py-3 px-4"
              >
      ...
      <div className="relative hidden flex-1 items-center justify-center border-l-2 border-black overflow-hidden bg-yellow-300 dark:bg-gray-800 dark:bg-opacity-30 md:block">
        <div className="w-full ">
          <div className="mt-10">
            ...
            >
              <div className="absolute top-1/2 -translate-y-1/2 rotate-12 dark:opacity-50 sm:translate-x-8 lg:translate-x-6">
  ...
  // return (
  //   <div className="hidden flex-1 flex-col items-center justify-center gap-4">
  //     <div>
  //       <Link className="mx-auto flex justify-center" to="/">
  //         <svg
  //           className="block h-9 text-black dark:text-white"
  ...
  //       </Link>
  //     </div>
  //     <h2 className="text-lg">Cookbase is a recipe organizer and meal planner for families.</h2>
  //     {user ? (
